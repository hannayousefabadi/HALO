#!/usr/bin/env python3
"""
Experiment: exp03_lgbm_bin_sspace_elementwise_nestedcv
...
import matplotlib
matplotlib.use("Agg")  # safe in tmux 
...
def main():
    ...
    out_dir = MODEL_RESULTS / "exp03_lgbm_bin_sspace_elementwise_nestedcv"
    ...
    # *** difference vs exp02: elementwise similarity ***
