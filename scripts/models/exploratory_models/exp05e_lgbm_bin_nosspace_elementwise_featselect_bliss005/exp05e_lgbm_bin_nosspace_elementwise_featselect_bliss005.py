#!/usr/bin/env python3
"""
Experiment: exp05e_lgbm_bin_nosspace_elementwise_featselect_bliss005
...
def main():
    ...
    out_dir = MODEL_RESULTS / "exp05e_lgbm_bin_nosspace_elementwise_featselect_bliss005"
    ...
    print(f'Number of selected CC-only features in exp05e: {len(selected_features)}')
