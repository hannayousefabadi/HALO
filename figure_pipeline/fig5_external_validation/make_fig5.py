...
External validation sanity check on Chandrasekaran et al. dataset (INDIGO) using HALO
...
def make_fig5():
    ...
    figB.tight_layout()
    out_png_B = OUT_DIR / "fig5_panelB_ROC.png"
    ...
    figC.tight_layout()
    out_png_C = OUT_DIR / "fig5_panelC_PR.png"
    ...
    figD.tight_layout()
    out_png_D = OUT_DIR / "fig5_panelD_scatter_CM.png"
